...
@Component({
  selector: 'app-query-ad',
  templateUrl: './query-ad.component.html',
  styleUrls: ['./query-ad.component.css']
})
export class QueryAdComponent implements OnInit {
...
public onConfirm(): void {
  this.onClose.next(this.selectedAD.samaccountname);
